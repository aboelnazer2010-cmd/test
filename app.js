...
function init() {
    ...
    // [تعديل جوهري] الاتصال بالخادم المحلي بدلاً من خوادم جوجل و PeerJS السحابية
    peer = new Peer(myId, {
        host: '192.168.1.10', // <--- غير هذا الرقم إلى الـ IP الخاص بجهازك المضيف
        port: 9000,
        path: '/myapp',
        config: { 
            'iceServers': [] // منع استخدام أي خوادم خارجية (مهم للعمل دون إنترنت)
        }
    });
